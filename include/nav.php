			<div id="navs ">
				<ul class="clearfix navs " id="menu-demo2">
					...
					<li class="nav-item"><a href="impayes.php" title="Interface d'administration">Impayes</a></li>
					<li class="nav-item"><a href="depense.php" title="Interface d'administration">Depenses</a></li>
					<li class="nav-item"><a href="admin/accueil.php" title="Interface d'administration">Recette annuelle</a></li>
				
					<li class="nav-item"><a href="part.php" title="Interface d'administration">Part</a></li>
				</ul>
			</div>
